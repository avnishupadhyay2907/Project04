...
public interface ORSView {
	...
	public String PORTFOLIO_MANAGEMENT_VIEW = PAGE_FOLDER + "/PortfolioManagementView.jsp";
	public String PORTFOLIO_MANAGEMENT_LIST_VIEW = PAGE_FOLDER + "/PortfolioManagementListView.jsp";
